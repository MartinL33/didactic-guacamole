...
class BaseSQLiteRestaurant extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		//insertion delivroo la rochelle
		double[] tabLat2={ 46.1575141, 46.162708, 46.1477607, 46.1622376, 46.1586048, 46.1570768, 46.161591, 46.15913, 46.1578932, 46.1566918, 46.1610825, 46.1584469, 46.161263, 46.1561313, 46.1620222, 46.1561278, 46.1587146, 46.1587031, 46.1491471, 46.1572162, 46.1562832, 46.1490773, 46.1583968, 46.1618665, 46.166285, 46.1553582, 46.1553968, 46.162474 };
		double[] tabLon2={ -1.1537418, -1.1235837, -1.1531624, -1.1494771, -1.1532161, -1.1555831, -1.1501986, -1.152744, -1.1491941, -1.1491579, -1.1488106, -1.1540972, -1.1491686, -1.1558581, -1.149225, -1.1557575, -1.1507109, -1.1506573, -1.144346, -1.1550883, -1.156129, -1.1446169, -1.1544231, -1.1526195, -1.1514406, -1.1478678, -1.1513224, -1.149665 };
		String[] tabNom2={ "Amorino","Au Marché d'Italie","Bagel Corner","Bagel Time","Bambou","Café Coulisses","Comtesse du Barry","Garden Café","La Bonne Pâte","La Fabrique à Burgers","La Pause du Marché","L'Atelier des Cousins","Le Bistrot de Mémé","Le Shalimar","Le Village Crétois","L'Entracte by Grégory Coutanceau","L'Italien Épicerie","L'Italien Pizzeria","Maxi Kebab","Maxi Liban","Mozzarella by Baïtona","Naamya","Rigoletto","Sushi Shop","Toto Pizz","Wok 88","Yamato Le Gabut","Yamato Marché Central" };
		if(tabLat2.length==tabLon2.length&&tabLat2.length==tabNom2.length){
			for(int i=0;i<tabLat2.length;i++){
				insertResto(db,tabLat2[i],tabLon2[i],tabNom2[i],4,0);
			}
		}
		else Log.d("BDD Resto","erreur taille table différente");
