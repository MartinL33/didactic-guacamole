...
//base de donnee localisation
    ...
    static final String COL_LATITUDE_LOCAL = "LATITUDE";
    static final int NUM_COL_LATITUDE_LOCAL = 1;
    static final String COL_LONGITUDE_LOCAL = "LONGITUDE";
...
//base de donnee temp
	...
	static final String COL_LATITUDE_TEMP = "LATITUDE";
	static final int NUM_COL_LATITUDE_TEMP = 1;
	static final String COL_LONGITUDE_TEMP = "LONGITUDE";
	static final int NUM_COL_LONGITUDE_TEMP = 2;
